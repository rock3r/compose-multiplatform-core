...
class JbrSkiaCommandRecorderTest {
    ...
    fun writesParagraphTextRecord() {
        ...
        assertArrayEquals(
            intArrayOf(
                1246972723, 22, 0, 22, 1, 1,
                19, 88, 1, 1250, 2500, 120000, 13000, Color.White.toArgb(), 700, 5, 1, 2, 1, 1500, 1, 1, 5,
