...
class JbrSkiaCommandRecorderTest {
    ...
    fun writesParagraphTextRecord() {
        ...
        assertArrayEquals(
            intArrayOf(
                1246972723, 18, 0, 14, 1, 1,
                19, 56, 1, 1250, 2500, 120000, 13000, Color.White.toArgb(), 5,
