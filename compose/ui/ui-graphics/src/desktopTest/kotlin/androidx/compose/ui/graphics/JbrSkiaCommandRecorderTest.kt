        ...
        withStrictCommandRecording {
            val commands = JbrSkiaCommandRecorder.record {
                JbrSkiaCommandRecorder.drawRect(
                    ...
                    bottom = 12f,
                    paint = Paint().apply {
                        shader = ImageShader(ImageBitmap(2, 2))
                    },
                )
            }
