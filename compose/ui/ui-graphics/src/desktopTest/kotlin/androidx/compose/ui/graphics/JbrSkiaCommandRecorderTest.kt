...
class JbrSkiaCommandRecorderTest {
    ...
    fun writesParagraphTextRecord() {
        ...
        assertArrayEquals(
            intArrayOf(
                1246972723, 19, 0, 17, 1, 1,
                19, 68, 1, 1250, 2500, 120000, 13000, Color.White.toArgb(), 700, 5, 1, 5,
